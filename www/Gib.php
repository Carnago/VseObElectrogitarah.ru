...
?>
				...
				<button onclick='function_120927052033();'>ИзменитьКонтент</button>
				<script>
				function function_120927052033() {
					if(document.getElementById('id_120827052033').style.visibility=='visible')
					{document.getElementById('id_120827052033').style.visibility='hidden';}
					else
					{document.getElementById('id_120827052033').style.visibility='visible';}
				}
				</script>
			</td>
		...
		<tr >
			<td valign="top" id="id_120827052033">
...
<script>
	function onchange_78452387478234()
	{
		...
		alert("Вы уверены?");
		window.open("http://vseobelectrogitarah.ru/Gib.php"
			+"?"
