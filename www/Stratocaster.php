...
?>
				...
				<button onclick='function_120927052023();'>ИзменитьКонтент</button>
				<script>
				function function_120927052023() {
					if(document.getElementById('id_120827052023').style.visibility=='visible')
					{document.getElementById('id_120827052023').style.visibility='hidden';}
					else
					{document.getElementById('id_120827052023').style.visibility='visible';}
				}
				</script>
			</td>
		...
		<tr >
			<td valign="top" id="id_120827052023">
				...
				<textarea id="id_160923052023_textarea" onchange="onchange_78452387478234();" id="skjfhgkdfgksdgjk">
<?php
	$conn = new mysqli("localhost", "Moderator", "270380","VseOElectroGitarah");
	if($conn->connect_error){die("Ошибка: " . $conn->connect_error);}
$sql = <<<SQL
...
<script>
	function onchange_78452387478234()
	{
		...
		window.open("http://vseobelectrogitarah.ru/Stratocaster.php"
			+"?"
			+"LogInn="+encodeURIComponent(document.getElementById("LogInn").value)
			+"&"
			+"PassWord="+encodeURIComponent(document.getElementById("PassWord").value)
			+"&"
			+"text="+encodeURIComponent(document.getElementById("id_160923052023_textarea").value)
		);
