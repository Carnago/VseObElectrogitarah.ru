...
?>
				...
				<button onclick='function_120927052034();'>ИзменитьКонтент</button>
				<script>
				function function_120927052034() {
					if(document.getElementById('id_120827052034').style.visibility=='visible')
					{document.getElementById('id_120827052034').style.visibility='hidden';}
					else
					{document.getElementById('id_120827052034').style.visibility='visible';}
				}
				</script>
			</td>
		...
		<tr >
			<td valign="top" id="id_120827052034">
...
<script>
	function onchange_78452387478234()
	{
		...
		alert("Вы уверены?");
		window.open("http://vseobelectrogitarah.ru/Iba.php"
			+"?"
